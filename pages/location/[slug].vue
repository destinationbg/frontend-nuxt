        ...
        <div class="sections">
            ...
            <LocationHistory
                :data="{
                    ...
                    slug: location.slug,
                    title: location.title,
                    authors: location.content.authors
                }"
            />
