export default {
    ...
    page: {
        ...
        location: {
            ...
            content: {
                authors: 'Автор на съдържанието е | Автори на съдържанието са',
                contribute:
                    'Цялото текстово съдържание във връзка с <strong>{location}</strong> е предоставено напълно доброволно от потребителите на сайта и ние не носим отговорност за авторските права върху него. Ако желаете да допринесете, можете да го направите чрез нашето <a href="{repositoryUrl}" target="blank" rel="noopener">GitHub хранилище</a>, след като прочетете нашия <a href="{contributingUrl}" target="blank" rel="noopener">Наръчник на доброволеца</a>.'
            }
        },
        legal: {
            termsAndConditions: {
